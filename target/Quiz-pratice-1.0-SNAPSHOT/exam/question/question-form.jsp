...
<jsp:include page="../../common/menu.jsp"></jsp:include>
        <div class="container mt-4 ttr-wrapper">
            ...
            <form action="QuestionBankController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="teacherId" type="text" name="teacherId" class="form-control" value="${question != null ? question.teacherId : ''}" required />
                </div>
        ...
        <script>
            ...
            // Add more answer fields dynamically
            document.getElementById("addAnswerButton").addEventListener("click", function () {
                var answersContainer = document.getElementById("answersContainer");
                var newAnswerCount = answersContainer.children.length + 1; // Count existing fields
            ...
            // Function to remove answer fields
            ...
            // Add listener to existing remove buttons
