 ...
 * @author HP
 */
@WebServlet(name = "DeleteClassController", urlPatterns = {"/DeleteClassController"})
public class DeleteClassController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(result > 0) {
            response.sendRedirect("ListClassController?success=Delete successfully");
        }
        else {
            response.sendRedirect("ListClassController?error=Delete fail. Class have student in this.");
        }
    }
