...
<jsp:include page="../../common/menuTeacher.jsp"></jsp:include>
    ...
    <form action="ExamController" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="examType" id="examType" class="form-control" value="${exam.examType}" required>
        </div>
        ...
        <a href="ExamController" class="btn btn-success mt-3">Back to Exam List</a>

        <!-- Links to manage questions -->
        <div class="mt-4">
        <c:if test="${exam != null}">
